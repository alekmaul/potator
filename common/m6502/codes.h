...
/** 65C02 commands. It is included from M65C02.c.           **/
/**                                                         **/
...
case 0x14: MR_Zp(I);M_TRB(I);break; /* uso */
...
case 0x1C: MR_Ab(I);M_TRB(I);break; /* uso */
...
case 0x28:
  ...
  R->P=I|R_FLAG|B_FLAG; /* B_FLAG added from new M6502 */
  break;
...
case 0x30:
  if(R->P&N_FLAG) {M_JR;} else R->PC.W++;
  break; /* BMI * REL */
